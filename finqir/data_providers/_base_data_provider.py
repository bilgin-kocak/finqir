...
class BaseDataProvider(ABC):
    """The abstract base class for :code:`data_provider` modules within FinQIR.
    ...
    def _check_data_loaded(self) -> None:
        ...
        Raises:
            FinQIRError: If no data is loaded. Please run the method :code:`run()`
    ...
    def get_period_return_covariance_matrix(self) -> np.ndarray:
        ...
        Raises:
            FinQIRError: If no data is loaded. Please run the method :meth:`run()`
                first to load the data.
        """
        self._check_data_loaded()
