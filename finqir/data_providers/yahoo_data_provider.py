...
class YahooDataProvider(BaseDataProvider):
    ...
    def run(self) -> None:
        ...
        Raises:
            FinQIRError: If there are missing tickers in download,
        ...
        if len(self._tickers) == 0:
            raise FinQIRError("Missing tickers to download.")
        self._data = []
        stocks_notfound = []
        try:
            ...
            raise FinQIRError("Accessing Yahoo Data failed.") from ex
