...
class ExchangeDataProvider(BaseDataProvider):
    ...
    def __init__(
        ...
        Raises:
            FinQIRError: provider doesn't support given stock market.
        """
        super().__init__()
    ...
    def run(self) -> None:
        ...
        for _, ticker_name in enumerate(self._tickers):
            ...
            try:
                ...
                raise FinQIRError(f"Cannot parse Nasdaq Data Link '{name}' output.") from ex
